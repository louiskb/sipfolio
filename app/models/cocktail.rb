class Cocktail < ApplicationRecord
  ...
  COCKTAIL_IMAGES = (1..10).map { |i| "cocktail-#{i}.jpg" } # Builds an array of strings with reference to the cocktail image file names ["cocktail-1.jpg", "cocktail-2.jpg", "cocktail-3.jpg", "...", "cocktail-26.jpg"]
